        ...
        <div className="container bg-white">
          <div className="coading-in">
            ...
            <div className="coading-right">
              ...
              <h1>Javascript Community</h1>
              <div className="talk">
                <ul className="cleafix">
                  <li className="active"><Link href="#">Join Us</Link></li>
                </ul>
              </div>
            </div>
            ...
            <ul className="clearfix">
              ...
              <li>
                ...
                <div>
                  ...
                  <p><span className="teach">100% Real Projects</span></p>
                  <p>
                    We help you learn with real-world projects that provides you
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    <span>Speed-up <br />Learning</span>
                  </p>
                  <p>
                    With our help, you can increase your learning speed by up to
                    200%
                  </p>
                  </div>
                </Link>
                ...
                <ul className="clearfix">
                  <li>
                    ...
                    <p>
                      ...
                      jobs and possess decades of real-life experience who have
                      a passion for helping coders of all ages. Coding can be
                      hard at times, and we are aware of the various roadblocks
                      you may encounter. Let us help and guide you to be your
                      best.
                    </p>
                  </li>
                  <li style={{marginTop: "60px"}}>
                    ...
                    <p>
                      We provide a private Discord room where we either provide
                      support, mentor, and guide our members to further
                      enhanance their abilities. Our aim is to develop you into
                      a 10x Javascript full-stack developer.
                    </p>
                  </li>
            {/*
                  <li>
        ...
        <div className="container" style={{ backgroundColor: "white", padding: "30px" }}>
          <div className="mission-sec">
            <p style={{ paddingLeft: "110px" }} >
              Our mission is to teach through through project-based curriculums
              to craft and hone their skills.”
            </p>
          </div>
            ...
            <ul className="clearfix">
              <li>
                ...
                <div>
                  ...
                  <span>Stephen K.</span>
                  <p>
                    Before using JS.social, I was pretty struggling. I simply
                    was ready to drop it. But after being a part of Js.social
                    for a few months, I understand Javascript at a much greater
                    level and fully confident in my abilities! Thank you!
                  </p>
                  </div>
                </Link>
              </li>
              <li className="">
                ...
                <div>
                  ...
                  <p>
                    ...
                    up-to-date with best practices, which is what I appreciate
                    the most. I just love being part of the chat, there are
                    always fun topics going on!
                  </p>
                  </div>
                </Link>
              </li>
              <li>
                ...
                <div>
                  ...
                  <span>Anne T.</span>
                  <p>
                    The mentors did a good job of providing me with the skills
                    necessary to ultimatey help land a job as a software
                    developer!. The mentors were solid as they were always there
                    to guide me on a daily basis.
                  </p>
                  </div>
                </Link>
              </li>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div>
                  ...
                  <p className="mt-3 max-w-3xl text-lg leading-7 text-gray-500">
                    We have helped members land their dream jobs in some of the most respected companies
                  </p>
                  <div className="mt-8 sm:flex">
                    <div className="rounded-md shadow">
                      <Link href="#" className="flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-black hover:bg-indigo-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                        Learn More
                      </Link>
                    </div>
            ...
            <div className="container">
              <div className="invest-sec">
                <div className="invest-sec-left">
                  <Link href="#"
                    ><img src="images/img2.jpg" alt="img" width="443" height="440"/>
                    </Link>
                </div>
